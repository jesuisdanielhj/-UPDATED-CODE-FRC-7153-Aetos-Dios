 ...
 *
 */
public class DriveWithHighSpeed extends Command {

    public DriveWithHighSpeed() {
    ...
    protected void execute() {
    	...
    	double forward = Robot.m_oi.Forward()/1.25;
    	double backward = Robot.m_oi.Backward()/1.25;
    	double throttle;
    	double turn = Robot.m_oi.DriveLeftAndRight()/1.25;
    	if ((forward>0.05)&&(backward>0.05)) {
    		...
    		throttle = 0;
    		turn = Robot.m_oi.DriveLeftAndRight();
    	}
